...
export default class {
  ...
  getReferenceData () {
    ...
    return this._base.get(ENDPOINTS.REFERENCE_DATA.REFERENCE_DATA(), request)
  }
  ...
  createReferenceData (referenceData) {
    ...
    return this._base.post(ENDPOINTS.REFERENCE_DATA.CREATE_REFERENCE_DATA(), request)
  }

  deleteReferenceData (id) {
    const request = this.createRequest({
      middleware: [ autoLogin ]
    })
    return this._base.delete(ENDPOINTS.REFERENCE_DATA.DELETE_REFERENCE_DATA(id), request)
  }
}
